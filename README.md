...
1. [Purpose of This Guide](#i-purpose-of-this-guide)
2. [The Four Core Grades](#ii-the-four-core-grades)
3. [Testing Methods (No Technology Required)](#iii-testing-methods-no-technology-required)
4. [Secondary Properties](#iv-secondary-properties)
5. [Material Profile Sheet](#v-material-profile-sheet)
6. [Reference Table: Known Materials](#vi-reference-table-known-materials)
7. [Unknown Materials: How to Identify and Log Them](#vii-unknown-materials-how-to-identify-and-log-them)
8. [Crafting Recommendations by Profile](#viii-crafting-recommendations-by-profile)
9. [Building Your Testing Station](#ix-building-your-testing-station)
10. [Final Notes](#x-final-notes)
...
A material is written as: **H\_/F\_/B\_/D\_** (e.g., `H7/F8/B4/D2`)
...
**Test:** Use the Standard Bending Rig (see [Section IX](#ix-building-your-testing-station)). Place a sample across two supports, hang standardized weights from the center, and measure deflection.
...
**Test:** Use the Drop Tower (see [Section IX](#ix-building-your-testing-station)). Drop a standardized weight from increasing heights onto a supported sample. Record the height at which the sample cracks or shatters.
...
> **Note on Heat:** Some materials change grade dramatically when heated. Always record both cold and hot grades where possible:
> `D3(cold) / D7(hot)` — hard to work cold, very workable hot.
...
- A set of standardized weights (see [Section IX](#ix-building-your-testing-station))
...
Fill in a Material Profile Sheet ([Section V](#v-material-profile-sheet)). Give it a name. If you don't know what it is, name it by source and appearance:
...
A shiny material isn't always strong. A dull one isn't always weak. Monster parts may look terrifying but test as H2/B2 — useless. Or a plain-looking bone might test at H8/F6/B8/D3 — treasure. Always test. Always record.
...
<p align="center"><em>"Measure twice. Test once. Build to last."</em><br><strong>— First Principle of the Post-Collapse Craftsman</strong></p>
